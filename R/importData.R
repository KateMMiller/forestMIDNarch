...
importData<- function(odbc="MIDNFVM"){
  ...
  assign("saps", sqlFetch(db,"tbl_Microplot_Sapling_Data_MIDN"),envir=.GlobalEnv)
  setTxtProgressBar(pb,10)
  assign("micro",sqlFetch(db,"tbl_Microplot_Characterization_Data"),envir=.GlobalEnv)
  setTxtProgressBar(pb,11)
  assign("sdlg",sqlFetch(db,"tbl_Quadrat_Seedling_Data"),envir=.GlobalEnv)
