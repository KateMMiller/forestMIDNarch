...
#------------------------
joinTreeData<-function(status='all',speciesType='all',park='all',from=2007,to=2018,QAQC=FALSE,locType='VS',output){
  treeTSN<-merge(trees[,c("Tree_ID","Location_ID","TSN","Tree_Number_MIDN")],
